      ...
      <div id="header-bottom-wrap" class="is-clearfix">
        <div id="header-bottom" class="site-header-bottom">
          <div id="header-bottom-inner" class="site-header-bottom-inner ">
            <section class="hero page-title is-medium has-text-centered blog-single" style="background: #812323 url({{ asset('/public/frontend/assets/images/page-header/6.jpg') }}) no-repeat top center; background-size: cover;}">
              <div class="hero-body">
                <div class="container">
                </div>
                <!-- .hero-body -->
                  ...
                  <div class="columns is-variable is-gapless is-multiline">
                    ...
                    <div class="column is-3 branding " data-aos="fade">
                      <div class="work-item">
                        <figure>
                        <?php $var = "img".$i;?>
                          <a href="{{ asset('/storage/'.$exhibitions[0]->$var) }}" class="mfp-lightbox mfp-image" title="">
                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="{{ asset('/storage/'.$exhibitions[0]->$var) }}">
                            <figcaption>
                              <ul class="social">
                                <li>
                                  <span class="icon">
                  ...
                  <div class="columns is-variable is-3 is-multiline">
                    @foreach($series as $versions)
                      ...
                      <div class="column is-4 branding " data-aos="fade-up">
                        <div class="work-item">
                          <figure>
                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="{{ asset('/storage/'.$exhibitions->img) }}">
                          </figure>
                        </div>
                        <!-- .work-item -->
                      </div>

...
<html lang="en" class="no-js no-svg">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ URL::asset('frontend/assets/images/favicons/vivo_favicon.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('frontend/assets/images/favicons/vivo_favicon.png') }}">

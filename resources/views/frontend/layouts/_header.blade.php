...
<html lang="en" class="no-js no-svg">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ URL::asset('public/frontend/assets/images/favicons/vivo_favicon.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('public/frontend/assets/images/favicons/vivo_favicon.png') }}">
    <link rel="shortcut icon" href="{{ URL::asset('public/frontend/assets/images/favicons/favicon.ico') }}"> 
    </head>
    <body class="active-pageloader corporate header-sticky hide-on-scroll header-menu-with-icons header-transparent footer-widgets footer-background dark-color widgets-6 submenu-show-arrow-right menu-is-capitalized submenu-is-capitalized logo-text-is-capitalized page-index">
                                      ...
                                      <div class="media-left">
                                        <figure class="image">
                                          <a href="./blog/single.html">
                                            <img alt="VIVO Bangladesh" src="assets/images/blog/1-1.png"> </a>
                                        </figure>
                                      </div>
                                  ...
                                  <div class="box">
                                    <article class="media">
                                      ...
                                      <div class="media-left">
                                        <figure class="image">
                                          <a href="./blog/single.html">
                                            <img alt="VIVO Bangladesh" src="assets/images/blog/1-2.png"> </a>
                                        </figure>
                                      </div>
                                      <div class="media-content">
                                        <div class="content">

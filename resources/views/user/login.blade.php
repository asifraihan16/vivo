                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box" style="background-color: #3280dd;">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-white font-18">User Login Panel</h4> 
                                    </div>
                                </div>
                                <div class="card-body p-0">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">                                       
                                            <form class="form-horizontal auth-form" method="POST" action="{{url('user/post-login')}}">
                                                {{ csrf_field() }}
                                            ...
                                            <div class="m-3 text-center text-muted">
                                                <p class="mb-0">Don't have an account ?  <a href="{{url('user/register')}}" class="text-primary ms-2">Register</a></p>
                                            </div>

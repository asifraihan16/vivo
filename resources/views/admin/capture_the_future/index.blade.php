                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title float-left">Capture the Future Images</h4>
                                    ...
                                    <tbody>
                                        @foreach ($moments as $key => $moment)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($moment->is_active == 1)
                                                        <a href="{{ route('capture_the_future.update-status', ['capture_the_future' => $moment->id, 'status' => 2]) }}"
                                                            onclick="return confirm('Are you sure want to deactivate?')"
                                                            class="btn btn-warning btn-sm btn-icon" title="Deactivate">
                                                            <i class="fa fa-thumbs-down"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('capture_the_future.update-status', ['capture_the_future' => $moment->id, 'status' => 1]) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('capture_the_future.destroy', ['capture_the_future' => $moment->id]) }}"

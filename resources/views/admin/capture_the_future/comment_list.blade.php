                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title float-left">Capture the Future Comments</h4>
                                        ...
                                        @foreach ($moments as $key => $moment)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('capture_the_future_comment_reply', ['comment_id' => $moment->id]) }}"
                                                        class="btn btn-success btn-sm btn-icon" title="All  Reply">
                                                        <i class="fa fa-eye"></i>

                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">                                    
                                                    <div class="general-label">
                                                        <form class="form-horizontal auth-form" method="POST" action="{{route('campaigns.update', $data[0]->id)}}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            @method('PUT')
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title" required="" value="{{ $data[0]->title }}">
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Campaign Title Details" name="title_detail" required="" value="{{ $data[0]->title_detail }}">
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class=" col-lg-12 col-md-12 col-sm-12">
                                                                    <textarea id="basic-conf" name="desc">{{ $data[0]->desc }}</textarea>

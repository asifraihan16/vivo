<div class="left-sidenav">
            ...
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);"> <i data-feather="layers" class="align-self-center menu-icon"></i><span>Backend</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li class="nav-item"><a class="nav-link" href="{{ route('mobile-series.index') }}"><i class="ti-control-record"></i>Mobile Series</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('mobile_series_versions.index') }}"><i class="ti-control-record"></i>Mobile Series Version</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('tags.index') }}"><i class="ti-control-record"></i>Tags</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('admin/pending_request') }}"><i class="ti-control-record"></i>Pending Request</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('admin/approved_request') }}"><i class="ti-control-record"></i>Approved Request</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/playlist1_main_vedios') }}"><i class="ti-control-record"></i>Main Vedio</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/playlist1_other_vedios') }}"><i class="ti-control-record"></i>Others Vedios</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="javascript: void(0);"> <i data-feather="grid" class="align-self-center menu-icon"></i><span>Playlist 2</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/playlist2_main_vedios') }}"><i class="ti-control-record"></i>Main Vedio</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/playlist2_other_vedios') }}"><i class="ti-control-record"></i>Others Vedios</a></li>
                                </ul>
                            </li>
                    ...
                    <li>
                        <a href="{{url('admin/logout')}}"> <i data-feather="box" class="align-self-center menu-icon"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </div>

                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{ url('admin/exibition_upload/create') }}"><button type="button" class="btn btn-outline-info float-right">Create</button></a>
                                </div><!--end card-header-->
                                <div class="card-body">
                                            ...
                                            <tbody>
                                            	@foreach($data as $key=>$value) 
		                                            <tr>
		                                                ...
		                                                <td><img width="100px" src="{{ asset('/storage/'.$value->img8) }}"></td>
		                                                <td class="text-right">
	                                                        <a href="{{ route('exibition_upload.edit', $value->id) }}" class="btn btn-outline-warning">Edit</a>
		                                                </td>
		                                            </tr>
	                                            @endforeach
                                            </tbody>

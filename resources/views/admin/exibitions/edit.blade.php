                                        ...
                                        <div class="card-body">
                                            <div class="general-label">
                                                <form class="form-horizontal auth-form" method="POST"
                                                    action="{{ route('exibition_upload.update', $data[0]->id) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                1(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img1) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                2(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img2) }}"
                                                                    width="200px" height="200px">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                3(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img3) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img3" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                4(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img4) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img4" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                5(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img5) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img5" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                6(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img6) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img6" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                7(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img7) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img7" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <label for="horizontalInput1"
                                                                class="col-sm-6 form-label align-self-center mb-lg-0">Image
                                                                8(Dimension : 770px * 475px, Size : 80kb)</label>
                                                            <div class="col-sm-6">
                                                                <img src="{{ Storage::url($data[0]->img8) }}"
                                                                    width="200px" height="200px">
                                                                <input type="file" id="input-file-now"
                                                                    class="form-control" name="img8" />

                                        ...
                                        <div class="col-lg-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Play 1 Other Vedios</h4>                                                    
                                                </div><!--end card-header-->
                                                <div class="card-body">                                    
                                                    <div class="general-label">
                                                        <form class="form-horizontal auth-form" method="POST" action="{{url('admin/playlist1_other_vedios')}}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="mb-3 row">
                                                                <label for="horizontalInput1" class="col-sm-2 form-label align-self-center mb-lg-0">Playlist Image(Dimension : 370px * 260px)</label>
                                                                <div class="col-sm-10">

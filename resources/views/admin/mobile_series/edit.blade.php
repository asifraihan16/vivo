                                        ...
                                        <div class="col-lg-8">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Mobile Series Edit</h4>                                                    
                                                </div><!--end card-header-->
                                                <div class="card-body">                                    
                                                    <div class="general-label">
                                                        <form class="form-horizontal auth-form" method="POST" action="{{ route('mobile-series.update', $data[0]->id) }}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            @method('PUT')
                                                            <div class="mb-3 row">

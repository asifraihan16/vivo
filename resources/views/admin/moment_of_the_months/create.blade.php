                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">                                    
                                                    <div class="general-label">
                                                        <form class="form-horizontal auth-form" method="POST" action="{{url('admin/moment_of_the_months')}}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title1" required="" value="{{ old('title1') }}">
                                                                        {!! $errors->first('title1', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 1 (Dimension : 450px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link1" required="" value="{{ old('link1') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title2" required="" value="{{ old('title2') }}">
                                                                        {!! $errors->first('title2', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 2(Dimension : 9000px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link2" required="" value="{{ old('link2') }}">
                                                           ...
                                                           <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title3" required="" value="{{ old('title3') }}">
                                                                        {!! $errors->first('title3', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 3(Dimension : 450px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link3" required="" value="{{ old('link3') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title4" required="" value="{{ old('title4') }}">
                                                                        {!! $errors->first('title4', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 4(Dimension : 900px * 900px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link4" required="" value="{{ old('link4') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title5" required="" value="{{ old('title5') }}">
                                                                        {!! $errors->first('title5', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 5(Dimension : 450px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link5" required="" value="{{ old('link5') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title6" required="" value="{{ old('title6') }}">
                                                                        {!! $errors->first('title6', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 6(Dimension : 450px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link6" required="" value="{{ old('link6') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="title7" required="" value="{{ old('title7') }}">
                                                                        {!! $errors->first('title7', '<p class="help-block">:message</p>') !!}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    <label for="horizontalInput1" class="col-sm-12 form-label align-self-center mb-lg-0">Image 7Dimension : 900px * 450px, Size : 150kb)</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="horizontalInput1" placeholder="Enter Mobile Series Name" name="link7" required="" value="{{ old('link7') }}">

...
class PhotographerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'img1' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id2' => 'required',
            'img2' => 'mimes:jpeg,jpg|dimensions:width=586,height=825',
            'mobile_series_versions_id3' => 'required',
            'img3' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id4' => 'required',
            'img4' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id5' => 'required',
            'img5' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id6' => 'required',
            'img6' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id7' => 'required',
            'img7' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id8' => 'required',
            'img8' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
            'mobile_series_versions_id9' => 'required',
            'img9' => 'mimes:jpeg,jpg|dimensions:width=602,height=602',
        ];

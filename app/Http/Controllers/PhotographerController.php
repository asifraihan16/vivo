...
class PhotographerController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $rules = [
        ...
        'img1' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id2' => 'required',
        'img2' => 'mimes:jpeg,jpg|dimensions:width=586,height=825|max:100',
        'mobile_series_versions_id3' => 'required',
        'img3' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id4' => 'required',
        'img4' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id5' => 'required',
        'img5' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id6' => 'required',
        'img6' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id7' => 'required',
        'img7' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id8' => 'required',
        'img8' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
        'mobile_series_versions_id9' => 'required',
        'img9' => 'mimes:jpeg,jpg|dimensions:width=602,height=602|max:100',
      ];
    ...
    {{
        $rules = [
          'title1' => 'required',
          'img1' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:70',
          'link1' => 'required',
          'title2' => 'required',
          'img2' => 'mimes:jpeg,jpg|dimensions:width=900,height=450|max:100',
          'link2' => 'required',
          'title3' => 'required',
          'img3' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:70',
          'link3' => 'required',
          'title4' => 'required',
          'img4' => 'mimes:jpeg,jpg|dimensions:width=900,height=900|max:150',
          'link4' => 'required',
          'title5' => 'required',
          'img5' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:70',
          'link5' => 'required',
          'title6' => 'required',
          'img6' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:70',
          'link6' => 'required',
          'title7' => 'required',
          'img7' => 'mimes:jpeg,jpg|dimensions:width=900,height=450|max:100',
          'link7' => 'required',
        ];

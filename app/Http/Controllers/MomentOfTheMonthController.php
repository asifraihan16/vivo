...
class MomentOfTheMonthController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $rules = [
        'title1' => 'required',
        'img1' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:800',
        'link1' => 'required',
        'title2' => 'required',
        'img2' => 'mimes:jpeg,jpg|dimensions:width=900,height=450|max:500',
        'link2' => 'required',
        'title3' => 'required',
        'img3' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:500',
        'link3' => 'required',
        'title4' => 'required',
        'img4' => 'mimes:jpeg,jpg|dimensions:width=900,height=900|max:500',
        'link4' => 'required',
        'title5' => 'required',
        'img5' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:500',
        'link5' => 'required',
        'title6' => 'required',
        'img6' => 'mimes:jpeg,jpg|dimensions:width=450,height=450|max:500',
        'link6' => 'required',
        'title7' => 'required',
        'img7' => 'mimes:jpeg,jpg|dimensions:width=900,height=450|max:500',
        'link7' => 'required',
      ];
      ...
      $this->validate($request, $rules, $customMessages);
        ...
        if ($request->file('img1')) {
            ...
            $upload_path = storage_path().'/app/public/momentOfTheMonth/';

            $image_path = 'app/public/momentOfTheMonth/';
